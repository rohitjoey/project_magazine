                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <a class="btn btn-primary"  href="javascript:;" onclick="editShareIcons(this);" data-icon_share = '<?php echo(json_encode($icon)) ?>'><i class="fa fa-edit"></i></a>
                                            <!-- <a href="addblog?id=<?php echo($blog->id);?> &amp; act=<?php echo substr(md5("Edit Blog".$blog->id.$_SESSION['token']), 3, 10); ?> "  class="btn btn-info" > -->
                                          <!-- <i class="fa fa-edit"></i> -->
                                        
                                            <a class="btn btn-danger" onclick="return  confirm('Are you sure you want to delete this blog?')" href="process/share?id=<?php echo( $icon->id)?>&amp;act=<?php echo(substr(md5("Delete-Share Icons-".$icon->id.$_SESSION['token']),5,15)) ?>" ><i class="fa fa-trash"></i></a>
                                        </td>
                                    </tr>
                                <?php
                                }
